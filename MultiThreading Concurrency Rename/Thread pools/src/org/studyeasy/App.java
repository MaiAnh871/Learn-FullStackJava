...
/*
 * If we want to manage these threads in a more efficient manner and we
 * would like to restrict the number of threads which are getting executed simultaneously.
 * Thread pools
 */
public class App {
